...
export async function togglePinnedChatApi(
  username
) {

  return apiRequest(
    `${API}/me/pinned-chats/toggle`,
    {
      method: "POST",
      headers: {
        "Content-Type":
...
export async function getArchivedChatsApi() {
  ...
  return apiRequest(
    `${API}/me/archived-chats`
  );

}

export async function toggleArchivedChatApi(
  username
) {

  return apiRequest(
    `${API}/me/archived-chats/toggle`,
    {
      method: "POST",
      headers: {
        "Content-Type":
